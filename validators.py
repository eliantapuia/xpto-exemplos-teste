...
import unittest
from test_valid_identifier import TestCheckValidIdentifier


class TestCheckValidIdentifier(unittest.TestCase):
    def test_valid_identifier(self):
        self.assertTrue(TestCheckValidIdentifier("my_variable"))
        self.assertTrue(TestCheckValidIdentifier("_start_with_underscore"))
        self.assertTrue(TestCheckValidIdentifier("can_contain_numbers123"))

    def test_invalid_identifier(self):
        self.assertFalse(TestCheckValidIdentifier("1start_with_number"))
        self.assertFalse(TestCheckValidIdentifier("has-hyphen"))
        self.assertFalse(TestCheckValidIdentifier("space in name"))
